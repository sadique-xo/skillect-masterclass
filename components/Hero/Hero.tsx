...
const avatars = [
    {
        imageUrl: "/images/avatar/Vetry Medium Small.jpeg",
        profileUrl: "#",
    },
    {
        imageUrl: "/images/avatar/Battala Prem Sagar Medium Small.jpeg",
        profileUrl: "#",
    },
    {
        imageUrl: "/images/avatar/Kalaichelvan   Medium Small.jpeg",
        profileUrl: "#",
    },
];
        ...
        <section className="hero" id="hero">
            ...
            <div className="container hero__container">
                ...
                <div className="hero__content">
                    ...
                    <div className="mb-10 flex items-center justify-start gap-4 max-lg:justify-center">
